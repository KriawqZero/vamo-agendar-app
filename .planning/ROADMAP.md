...
- [x] 01-19-PLAN.md — Alcance da D-03 escrito no `docs/03`, registro coerente em `PENDENCIAS`, e gate de reexecução de todas as provas sobre o HEAD final (wave 3, depende de 01-18)
...
- [x] 02-01-PLAN.md — Tracer: engine lê ocupação de `data_hora_fim` (D-02, AGE-01/AGE-02) (wave 1)
- [x] 02-02-PLAN.md — Schema final + RPC COALESCE + migration à mão (teste empírico de `periodo`) (D-01, AGE-03/AGE-05) (wave 1)
...
- [x] 02-04-PLAN.md — Walk-in + modal: `data_hora_fim`, RPC, 23P01 → `slot_ocupado` com detalhe, remarcação congela duração (D-03/D-04, AGE-01/AGE-03/AGE-04/AGE-05) (wave 2)

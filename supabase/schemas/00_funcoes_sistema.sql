...
-- Executa apenas via o mecanismo interno de event trigger do Postgres;
-- não deve ser exposta via API (PostgREST expõe funções do schema public
-- por padrão, e o Postgres concede EXECUTE a PUBLIC por padrão).
